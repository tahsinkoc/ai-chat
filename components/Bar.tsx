            ...
            <div className='w-full hh bg-primary rounded-2xl relative'>
                ...
                <div className='relative hhs overflow-y-scroll px-3'>
                    <div className='w-full flex flex-row'>
                        <button onClick={() => { setModel({ modelName: 'gemma:2b', includesImage: false }), setClicked(null) }} className='w-full hover:bg-input transition-all duration-300 rounded-lg py-4 px-4 outline-none border-none text-text my-[12px] text-start'>Gemma 2B</button>
